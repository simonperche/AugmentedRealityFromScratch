    ...
    namespace CV
    {
        ...
        cv::Mat estimateHomography(const std::vector<cv::Point>& srcPoints, const std::vector<cv::Point>& dstPoints)
        {
            ...
            std::array<double, 72> data{double(-srcPoints[0].x), double(-srcPoints[0].y), -1.0, 0.0, 0.0, 0.0,
                                        double(srcPoints[0].x) * double(dstPoints[0].x),
                                        double(srcPoints[0].y) * double(dstPoints[0].x),
                                        double(-dstPoints[0].x),
                                        0.0, 0.0, 0.0, double(-srcPoints[0].x), double(-srcPoints[0].y), -1.0,
                                        double(srcPoints[0].x) * double(dstPoints[0].y),
                                        double(srcPoints[0].y) * double(dstPoints[0].y),
                                        double(-dstPoints[0].y),
                                        double(-srcPoints[1].x), double(-srcPoints[1].y), -1.0, 0.0, 0.0, 0.0,
                                        double(srcPoints[1].x) * double(dstPoints[1].x),
                                        double(srcPoints[1].y) * double(dstPoints[1].x),
                                        double(-dstPoints[1].x),
                                        0.0, 0.0, 0.0, double(-srcPoints[1].x), double(-srcPoints[1].y), -1.0,
                                        double(srcPoints[1].x) * double(dstPoints[1].y),
                                        double(srcPoints[1].y) * double(dstPoints[1].y),
                                        double(-dstPoints[1].y),
                                        double(-srcPoints[2].x), double(-srcPoints[2].y), -1.0, 0.0, 0.0, 0.0,
                                        double(srcPoints[2].x) * double(dstPoints[2].x),
                                        double(srcPoints[2].y) * double(dstPoints[2].x),
                                        double(-dstPoints[2].x),
                                        0.0, 0.0, 0.0, double(-srcPoints[2].x), double(-srcPoints[2].y), -1.0,
                                        double(srcPoints[2].x) * double(dstPoints[2].y),
                                        double(srcPoints[2].y) * double(dstPoints[2].y),
                                        double(-dstPoints[2].y),
                                        double(-srcPoints[3].x), double(-srcPoints[3].y), -1.0, 0.0, 0.0, 0.0,
                                        double(srcPoints[3].x) * double(dstPoints[3].x),
                                        double(srcPoints[3].y) * double(dstPoints[3].x),
                                        double(-dstPoints[3].x),
                                        0.0, 0.0, 0.0, double(-srcPoints[3].x), double(-srcPoints[3].y), -1.0,
                                        double(srcPoints[3].x) * double(dstPoints[3].y),
                                        double(srcPoints[3].y) * double(dstPoints[3].y),
